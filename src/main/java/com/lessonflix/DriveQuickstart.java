...
public class DriveQuickstart {
  ...
  public static void listFiles(int pageSize) throws IOException, GeneralSecurityException {
  ...
  public static void searchFiles(String name) throws IOException, GeneralSecurityException {
    String pageToken = null;
    do {
      FileList result = createDriveService().files().list().setQ("name='" + name + "'").setSpaces("drive")
  ...
  public static void main(String... args) throws IOException, GeneralSecurityException {
    DriveQuickstart.searchFiles("ingles");
  }
